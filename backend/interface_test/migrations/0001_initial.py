    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(max_length=300, unique=True, verbose_name='token')),
            ],
            options={
                'db_table': 'api_token',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sno', models.ForeignKey(db_column='sno', on_delete=django.db.models.deletion.DO_NOTHING, to='interface_test.tbsubject')),
            ],
            options={
